...
public sealed class GetTaskHistoryQueryHandler : IRequestHandler<GetTaskHistoryQuery, IReadOnlyList<TaskHistoryEntryDto>>
{
    ...
    public async Task<IReadOnlyList<TaskHistoryEntryDto>> Handle(
        GetTaskHistoryQuery request, CancellationToken cancellationToken)
    {
        ...
        return await _taskHistoryRepository.GetForTaskAsync(request.TaskId, cancellationToken);
    }
}
